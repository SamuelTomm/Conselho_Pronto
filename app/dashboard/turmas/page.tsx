...
const menuItems = [
  ...
  { id: "turmas", label: "Turmas", icon: Send, active: true },
]
...
export default function TurmasPage() {
  ...
  if (viewMode === "alunos" && selectedTurma) {
    const alunosTurma = alunosPorTurma[selectedTurma.id as keyof typeof alunosPorTurma] || []
            ...
            <div className="px-6 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h1 className="text-xl font-semibold text-gray-900">{selectedTurma.nome}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">{alunosTurma.length}</p>
                    </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Conselheiro</p>
                      <p className="text-lg font-bold text-gray-900">{selectedTurma.conselheiro}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-bold text-gray-900">{selectedTurma.sala}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">{selectedTurma.disciplinas}</p>
                    </div>
                        ...
                        <TableRow key={aluno.id}>
                          ...
                          <TableCell>
                            <div className="flex flex-col">
                              ...
                              <span className="text-sm text-gray-500">{aluno.telefone}</span>
                            </div>
                          </TableCell>
                          <TableCell>
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Gestão de Turmas - Prof. Maria Silva</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Total de Alunos</p>
                    <p className="text-2xl font-bold text-gray-900">{turmas.reduce((acc, t) => acc + t.alunos, 0)}</p>
                  </div>
                  <div className="bg-green-100 p-3 rounded-full">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Ensino Médio</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {turmas.filter((t) => t.nivel === "Técnico").length}
                    </p>
                  </div>
                  <div className="bg-orange-100 p-3 rounded-full">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Visualize e gerencie todas as turmas da instituição</CardDescription>
                </div>
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <DialogFooter>
                        <Button type="submit">{editingTurma ? "Salvar" : "Adicionar"}</Button>
                      </DialogFooter>
                    </form>
                  </DialogContent>
                </Dialog>
